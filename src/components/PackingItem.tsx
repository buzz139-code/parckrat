    ...
    <div style={{
      ...
      <button onClick={onToggle} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, flexShrink: 0 }}>
        <div style={{
          ...
          border: item.packed ? 'none' : '1.5px solid rgba(44,26,14,0.2)',
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {editingQty ? (
          ...
          <button onClick={() => setEditingQty(true)} style={{ fontSize: 11, color: 'rgba(44,26,14,0.4)', background: 'none', border: 'none', cursor: 'text', padding: 0, textAlign: 'left', fontFamily: 'inherit', marginTop: 1 }}>
            {item.quantity}
          </button>
        )}
      </div>

      <button onClick={onRemove} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4, color: 'rgba(44,26,14,0.2)', flexShrink: 0, transition: 'color 0.15s' }}
        onMouseEnter={e => (e.currentTarget.style.color = '#991b1b')}
        onMouseLeave={e => (e.currentTarget.style.color = 'rgba(44,26,14,0.2)')}>
