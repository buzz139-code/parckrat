...
export default function TripTypeSelector({ selected, onChange }: Props) {
  ...
  return (
    <div>
      <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(44,26,14,0.4)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>
          ...
          return (
            <button
              ...
              style={{
                padding: '10px 8px',
                borderRadius: 10,
                border: isActive ? '1.5px solid #8B4513' : '1px solid rgba(44,26,14,0.1)',
            ...
            >
              ...
              <div style={{ fontSize: 10, color: 'rgba(44,26,14,0.4)', lineHeight: 1.3 }}>{type.description}</div>
            </button>
          );
        })}
      </div>
